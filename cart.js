...
p.innerText=elem.maintenance;
p.style.color="gray";
p.style.fontSize="small";
p.style.fontFamily="Radio Canada, sans-serif";
var p1=document.createElement("p")
p1.innerText=elem.pronotes;
p1.style.color="red";
...
//QUANTITY FEATURE MADE REDUNDANAT
...
var stax=document.querySelector("#tax").innerText=Math.ceil(0.18*finalrate);

document.querySelector("#fullamount").innerText=Math.ceil(100+(1.18*finalrate));

//UPDATE BUTTON HAS BEEN REVOKED
